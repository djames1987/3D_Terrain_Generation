...
from panda3d.core import BitMask32, WindowProperties, NodePath, PandaNode
...
class Player:
    def __init__(self, base, physics_world):
        ...
        # Load in physics world
        self.physics_world = physics_world

        # Create Player
        self.setup_player()
        self.sensitivity = ControlSettings.SENSITIVITY
        self.setup_controls()
    ...
    def setup_player(self):
        ...
        self.physics_world.attachCharacter(self.character)
    ...
    def update(self, task):
        ...
        if mw.hasMouse():
            ...
            self.base.win.movePointer(0, int(self.base.win.getProperties().getXSize() / 2), int(self.base.win.getProperties().getYSize() / 2))
        # Mouse controls
